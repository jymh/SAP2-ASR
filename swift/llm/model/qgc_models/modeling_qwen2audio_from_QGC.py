...
import transformers
from transformers import Qwen2AudioForConditionalGeneration, Qwen2AudioPreTrainedModel, Qwen2Model
...
class ModelWithQGC(Qwen2AudioPreTrainedModel, GenerationMixin):
    def __init__(self, args, compressor: Qwen2Model, pooling_layer, lm_model: Qwen2AudioForConditionalGeneration):
        super().__init__(lm_model.config)
        self.args = args
        
        self.compressor = transformers.AutoConfig.from_pretrained(os.path.join(os.path.expanduser("~"), "models/qwen2-7b"))

...
#     --model "/data/rym/models/qgc-qwen2-audio-instruct"  \
#     --model_type qgc_qwen2_audio \
...
NPROC_PER_NODE=8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 swift sft \
    ...
    --per_device_eval_batch_size 32 \
    --max_length 4096 \
    --output_dir "/data/rym/output/slidespeech_L95_lora_compress/window_size_2_no_param" \
    --train_type lora \
    --freeze_llm false \
    --freeze_vit true \
    --freeze_aligner false \
